...
public class Ciphers {
    public static void main(String[] args) {
        ...
        PositionallyShiftedCipher posshiftCipher = new PositionallyShiftedCipher();
        boolean running = true;
        int programState = 0; // 0 for menu, 1 for caesar, 2 for playfair, 3 for polybius, 4 for posshift
        String userInput;
        ...
        while (running) {
            switch(programState) {
                case 0:
                    ...
                    System.out.println("H - Positionally Shifted Cipher");
                ...
                case 3:
                    ...
                    break;
                case 4:
                    System.out.println("Positionally Shifted Cipher");
                    System.out.println("Operations:");
                    System.out.println("E - Encrypt");
                    System.out.println("D - Decrypt");
                    System.out.println("B - Back to Main Menu");
                    ...
                    String posshiftPlaintext;
                    String posshiftEncrypted;

                    switch (userInput.toLowerCase().charAt(0)) {
                        case 'e':
                            System.out.print("Enter plaintext: ");

                            posshiftPlaintext = input.nextLine();
                            posshiftEncrypted = posshiftCipher.encrypt(posshiftPlaintext);

                            System.out.println("'" + posshiftPlaintext.toUpperCase() + "' encrypted with the PosShift Cipher is: '" + posshiftEncrypted.toUpperCase() + "'");
                            System.out.print("Press ENTER to continue");
                            input.nextLine();
                            break;
                        case 'd':
                            ...
                            posshiftEncrypted = input.nextLine();
                            posshiftPlaintext = posshiftCipher.decrypt(posshiftEncrypted);

                            System.out.println("'" + posshiftEncrypted.toUpperCase() + "' decrypted with the PosShiftCipher is: '" + posshiftPlaintext.toUpperCase() + "'");
                            System.out.print("Press ENTER to continue");
                            input.nextLine();
                            break;
                        case 'b':
